...
- The user accounts being generated by the script enerted in Power Shell ISE should be visible in the "_EMPLYEES" folder in AD (Users & Computers)
- Select a ransom user (Ex: bal.qog) & Password: "Password1" (specefied in the script).
- The succesful log in will confirm that the VM1 has successfully been connected the Domina Server
