...
<p>  
3. Connect VM1 and DC1 to the remote desktop. 
...
- Notice the perpetual ping timeout due to the blockage of ICMP traffic due to the Network Security Group or "Firewall" on DC1
...
- Select the yeller "!" icon in the the top lect window if the Server Manager on DC1
...
- Select "Tools" the top right corner of the AD window and select "Active Directory Users and Computers"
...
- Create an admin account name "Jane Doe"
...
- Click on "Rename this PC (Advanced)" in the column on the right os the "System Settings" window
...
- The successful log in will confirm that the VM1 has successfully been connected the Domina Server
